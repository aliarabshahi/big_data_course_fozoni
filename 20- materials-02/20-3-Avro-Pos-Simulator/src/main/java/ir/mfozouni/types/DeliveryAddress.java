...
public class DeliveryAddress extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -8644043854364701136L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"DeliveryAddress\",\"namespace\":\"ir.mfozouni.types\",\"fields\":[{\"name\":\"AddressLine\",\"type\":[\"null\",\"string\"]},{\"name\":\"City\",\"type\":[\"null\",\"string\"]},{\"name\":\"State\",\"type\":[\"null\",\"string\"]},{\"name\":\"PinCode\",\"type\":[\"null\",\"string\"]},{\"name\":\"ContactNumber\",\"type\":[\"null\",\"string\"]}]}");
   ...
   */
  public static ir.mfozouni.types.DeliveryAddress.Builder newBuilder() {
    return new ir.mfozouni.types.DeliveryAddress.Builder();
  }
   ...
   * @return A new DeliveryAddress RecordBuilder
   */
  public static ir.mfozouni.types.DeliveryAddress.Builder newBuilder(ir.mfozouni.types.DeliveryAddress.Builder other) {
    return new ir.mfozouni.types.DeliveryAddress.Builder(other);
  }
   ...
   * @return A new DeliveryAddress RecordBuilder
   */
  public static ir.mfozouni.types.DeliveryAddress.Builder newBuilder(ir.mfozouni.types.DeliveryAddress other) {
    return new ir.mfozouni.types.DeliveryAddress.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<DeliveryAddress>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(ir.mfozouni.types.DeliveryAddress.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(ir.mfozouni.types.DeliveryAddress other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.AddressLine)) {
        this.AddressLine = data().deepCopy(fields()[0].schema(), other.AddressLine);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public ir.mfozouni.types.DeliveryAddress.Builder setAddressLine(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ir.mfozouni.types.DeliveryAddress.Builder clearAddressLine() {
      AddressLine = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public ir.mfozouni.types.DeliveryAddress.Builder setCity(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ir.mfozouni.types.DeliveryAddress.Builder clearCity() {
      City = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public ir.mfozouni.types.DeliveryAddress.Builder setState(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ir.mfozouni.types.DeliveryAddress.Builder clearState() {
      State = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public ir.mfozouni.types.DeliveryAddress.Builder setPinCode(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ir.mfozouni.types.DeliveryAddress.Builder clearPinCode() {
      PinCode = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public ir.mfozouni.types.DeliveryAddress.Builder setContactNumber(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ir.mfozouni.types.DeliveryAddress.Builder clearContactNumber() {
      ContactNumber = null;
