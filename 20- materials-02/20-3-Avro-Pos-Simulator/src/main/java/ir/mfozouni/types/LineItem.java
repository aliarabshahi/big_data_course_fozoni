...
public class LineItem extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -2030512271885893077L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"LineItem\",\"namespace\":\"ir.mfozouni.types\",\"fields\":[{\"name\":\"ItemCode\",\"type\":[\"null\",\"string\"]},{\"name\":\"ItemDescription\",\"type\":[\"null\",\"string\"]},{\"name\":\"ItemPrice\",\"type\":[\"null\",\"double\"]},{\"name\":\"ItemQty\",\"type\":[\"null\",\"int\"]},{\"name\":\"TotalValue\",\"type\":[\"null\",\"double\"]}]}");
   ...
   */
  public static ir.mfozouni.types.LineItem.Builder newBuilder() {
    return new ir.mfozouni.types.LineItem.Builder();
  }
   ...
   * @return A new LineItem RecordBuilder
   */
  public static ir.mfozouni.types.LineItem.Builder newBuilder(ir.mfozouni.types.LineItem.Builder other) {
    return new ir.mfozouni.types.LineItem.Builder(other);
  }
   ...
   * @return A new LineItem RecordBuilder
   */
  public static ir.mfozouni.types.LineItem.Builder newBuilder(ir.mfozouni.types.LineItem other) {
    return new ir.mfozouni.types.LineItem.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<LineItem>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(ir.mfozouni.types.LineItem.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(ir.mfozouni.types.LineItem other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.ItemCode)) {
        this.ItemCode = data().deepCopy(fields()[0].schema(), other.ItemCode);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public ir.mfozouni.types.LineItem.Builder setItemCode(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ir.mfozouni.types.LineItem.Builder clearItemCode() {
      ItemCode = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public ir.mfozouni.types.LineItem.Builder setItemDescription(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ir.mfozouni.types.LineItem.Builder clearItemDescription() {
    ...
    /**
      ...
      * @return This builder.
      */
    public ir.mfozouni.types.LineItem.Builder setItemPrice(java.lang.Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ir.mfozouni.types.LineItem.Builder clearItemPrice() {
      ItemPrice = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public ir.mfozouni.types.LineItem.Builder setItemQty(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ir.mfozouni.types.LineItem.Builder clearItemQty() {
      ItemQty = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public ir.mfozouni.types.LineItem.Builder setTotalValue(java.lang.Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ir.mfozouni.types.LineItem.Builder clearTotalValue() {
      TotalValue = null;
