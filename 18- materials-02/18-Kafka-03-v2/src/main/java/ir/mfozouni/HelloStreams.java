...
public class HelloStreams {
    ...
    public static void main(String[] args) {
        ...
        KStream<Integer, String> inputStreams = builder.stream(AppConfig.topicName);
        inputStreams.foreach((k, v) -> {
            System.out.println("Key= " + k + " and " + "Value= " + v);
        });

        KStream<Integer, String> secondStreams =
                inputStreams.mapValues(value-> value.toUpperCase());

        secondStreams.to(AppConfig.outputTopicName,
